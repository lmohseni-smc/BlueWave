...
public class DashboardUser extends javaxt.sql.Model {
  ...
  // ** Constructor
  // **************************************************************************
  /** Creates a new instance of this class using a JSON representation of a DashboardUser. */
  ...
  /**
   * Used to find a DashboardUser using a given set of constraints. Example: DashboardUser obj =
   * DashboardUser.get("user_id=", user_id);
   */
