...
public class Contact extends javaxt.sql.Model {
  ...
  // ** Constructor
  // **************************************************************************
  /** Creates a new instance of this class using a JSON representation of a Contact. */
  ...
  /**
   * Used to find a Contact using a given set of constraints. Example: Contact obj =
