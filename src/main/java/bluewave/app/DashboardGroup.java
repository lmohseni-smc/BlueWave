...
public class DashboardGroup extends javaxt.sql.Model {
  ...
  // ** Constructor
  // **************************************************************************
  /** Creates a new instance of this class using a JSON representation of a DashboardGroup. */
  ...
  /**
   * Used to find a DashboardGroup using a given set of constraints. Example: DashboardGroup obj =
   * DashboardGroup.get("name=", name);
   */
  ...
  protected void update(Object rs) throws SQLException {
    ...
    try {
      ...
      try {
        ...
        for (javaxt.sql.Recordset row :
            conn.getRecordset(
                "select dashboard_id from application.dashboard_group_dashboard where dashboard_group_id="
                    + id)) {
  ...
  public void save() throws SQLException {
    ...
    try {
      ...
      for (long dashboardID : dashboardIDs) {
        rs.open(
            "select * from application.dashboard_group_dashboard where dashboard_group_id="
                + id
                + " and dashboard_id="
                + dashboardID,
            conn,
