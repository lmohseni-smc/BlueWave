...
public class Dashboard extends javaxt.sql.Model {
  ...
  // ** Constructor
  // **************************************************************************
  /** Creates a new instance of this class using a JSON representation of a Dashboard. */
  ...
  /**
   * Used to find a Dashboard using a given set of constraints. Example: Dashboard obj =
