...
// ******************************************************************************
/**
 * Provides thread-safe, static methods used to get and set application variables.
 *
 * <p>****************************************************************************
 */
public class Config {
   ...
   *
   * @param path Full canonical path to a file or a relative path (relative to the jarFile)
   */
  ...
  // **************************************************************************
  /**
   * Used to update a path to a directory defined in a config file. Resolves both canonical and
   * relative paths (relative to the configFile).
   */
  public static void updateDir(
      String key, JSONObject config, javaxt.io.File configFile, boolean create) {
    if (config.has(key)) {
  ...
  // **************************************************************************
  /**
   * Used to update a path to a file defined in a config file. Resolves both canonical and relative
   * paths (relative to the configFile).
   */
