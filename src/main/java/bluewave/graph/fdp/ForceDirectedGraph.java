...
// ******************************************************************************
/**
 * Java implementation of Fruchterman and Reingold's graph layout algorithm using force-directed
 * placement. Credit: https://github.com/Benjoyo/ForceDirectedPlacement
 *
 * <p>****************************************************************************
 */
public class ForceDirectedGraph {
  ...
  /**
   * Used to pad a number with white spaces. Used when printing percent complete to the standard
   * output stream.
   */
            ...
            if (numThreads > 1) {
              ...
              synchronized (percentComplete) {
                if (currPercent > percentComplete.get()) {
                  ...
                  int elapsedTime =
                      (int) Math.round(((currTime - startTime) / 1000) / 60); // minutes
  ...
  /**
   * Calculates the amount of the attractive force between vertices using the following expression:
   * "(d * d) / k". Users can override this method to use a different expression.
   *
  ...
  /**
   * Calculates the amount of the repulsive force between vertices using the following expression:
   * "(k * k) / d". Users can override this method to use a different expression.
   *
   * @param d the distance between the two vertices
   * @param k
   * @return amount of force
