...
// ******************************************************************************
/**
 * Used to authenticate HTTP requests using "BASIC" authentication. This class is typically
 * instantiated within a servlet constructor and assigned to the servlet via the setAuthenticator()
 * method. Once an Authenticator is defined, several security-related methods will be available via
 * the HttpServletRequest object (e.g. getCredentials(), getUserPrincipal(), authenticate(), etc).
 *
 * <p>****************************************************************************
 */
public class Authenticator implements javaxt.http.servlet.Authenticator {
  ...
  /**
   * Creates a new instance of this class and parse user credentials. Called with each HTTP request
  ...
  /**
   * Used to authenticate a client request. If the Authenticator fails to authenticate the client,
   * this method throws a ServletException.
   */
  ...
  /**
   * Returns the authentication scheme used to authenticate clients. In this case, we use "BASIC"
   * authentication.
   */
