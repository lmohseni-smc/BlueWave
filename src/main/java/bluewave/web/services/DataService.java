...
// ******************************************************************************
/**
 * Used to generate CSV data associated with the path in the ServiceRequest. In most cases, the path
 * represents a name of a query in the "queries" package. If a suitable query is not found, a file
 * search is initiated to find a matching file in the data directory.
 *
 * <p>****************************************************************************
 */
